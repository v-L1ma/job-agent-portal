...
export function AuthLayout({ form, banner }: AuthLayoutProps) {
  return (
    <div className="flex min-h-screen w-full bg-white font-sans text-trampo-dark antialiased">
      ...
      <div className="relative hidden w-1/2 overflow-hidden bg-neutral-50 border-l border-neutral-100 lg:flex flex-col p-0">
        ...
        <div className="relative flex-1 w-full min-h-0 z-10 p-0">
          {banner}
        </div>
      </div>
    </div>
