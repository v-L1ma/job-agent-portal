        ...
        <div className="w-full flex flex-col gap-6">
          ...
          <div className="w-full bg-white border border-neutral-200/80 rounded-2xl p-6 shadow-[0_30px_70px_-15px_rgba(46,175,146,0.12)]">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="font-extrabold text-trampo-dark text-sm">Candidaturas Ativas</h3>
                <p className="text-[10px] text-trampo-muted font-medium">Painel em tempo real</p>
              </div>
              <span className="text-[10px] font-bold text-trampo-primary-600 bg-trampo-primary-50 px-2.5 py-1 rounded-full">
                +4 Novas
              </span>
            </div>
            ...
            <div className="space-y-3">
              {/* Row 1 */}
              <div className="flex items-center justify-between p-3 bg-neutral-50/50 rounded-xl border border-neutral-100">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-neutral-900 flex items-center justify-center font-bold text-white text-xs">
                    G
                  </div>
                  <div>
                    <h4 className="font-bold text-xs text-trampo-dark">Google</h4>
                    <p className="text-[10px] text-trampo-muted">Software Engineer</p>
                  </div>
                </div>
                <span className="text-[9px] font-extrabold uppercase tracking-wider text-trampo-primary-600 bg-trampo-primary-100 px-2 py-0.5 rounded-full">
                  Entrevista
                </span>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-neutral-50/50 rounded-xl border border-neutral-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-xs text-trampo-dark">Stripe</h4>
                    <p className="text-[10px] text-trampo-muted">Frontend Developer</p>
                  </div>
                </div>
                <span className="text-[9px] font-extrabold uppercase tracking-wider text-trampo-primary-600 bg-trampo-primary-100 px-2 py-0.5 rounded-full">
                  Proposta
              ...
              <div className="flex items-center justify-between p-3 bg-neutral-50/50 rounded-xl border border-neutral-100">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-xs text-trampo-dark">Netflix</h4>
                    <p className="text-[10px] text-trampo-muted">Product Designer</p>
                  </div>
                </div>
                <span className="text-[9px] font-extrabold uppercase tracking-wider text-neutral-500 bg-neutral-100 px-2 py-0.5 rounded-full">
                  Enviado
                </span>
              </div>
            </div>
          ...
          {/* Testimonial Quote floating block */}
          <div className="bg-white/90 backdrop-blur-md border border-neutral-200/60 p-6 rounded-2xl shadow-xl">
            <div className="flex gap-1 mb-3">
              <Star className="text-trampo-primary-500 size-3 fill-current" />
              <Star className="text-trampo-primary-500 size-3 fill-current" />
              <Star className="text-trampo-primary-500 size-3 fill-current" />
              <Star className="text-trampo-primary-500 size-3 fill-current" />
              <Star className="text-trampo-primary-500 size-3 fill-current" />
            </div>
            <blockquote className="text-xs font-semibold text-trampo-muted italic mb-4 leading-relaxed">
              &quot;O Trampo automatizou todo o processo cansativo de envio de currículos. Consegui 3 entrevistas na primeira semana.&quot;
            </blockquote>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-trampo-primary-200 text-trampo-primary-600 flex items-center justify-center font-extrabold text-xs">
                MC
              </div>
              <div>
                <p className="text-xs font-extrabold text-trampo-dark text-left">Mariana Costa</p>
                <p className="text-[10px] text-trampo-muted font-medium text-left">Product Manager na TechFlow</p>
              </div>
            </div>
          </div>
        </div>
